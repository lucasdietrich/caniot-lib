...
int main(void)
{
	...
	// caniot_build_query_telemetry(&req, tempsens.dev.identification->did, endpoint_default);
	caniot_build_query_telemetry(&req, CANIOT_DEVICE_BROADCAST, endpoint_default);
