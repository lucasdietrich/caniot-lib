...
#define CANIOT_ATTR_KEY_DIAG_RESET_COUNT_POWER_ON	CANIOT_ATTR_KEY(3, 0x02, 0) // 0x3002
#define CANIOT_ATTR_KEY_DIAG_RESET_COUNT_WATCHDOG	CANIOT_ATTR_KEY(3, 0x03, 0) // 0x3003
#define CANIOT_ATTR_KEY_DIAG_RESET_COUNT_EXTERNAL	CANIOT_ATTR_KEY(3, 0x04, 0) // 0x3004
#define CANIOT_ATTR_KEY_DIAG_RESET_COUNT_UNKNOWN	CANIOT_ATTR_KEY(3, 0x05, 0) // 0x3005
